...
- (NSMutableDictionary *)prepStagesForBill:(NSMutableDictionary *)bill {
	/*
	 Bills = 1-7
	 Simple Resolutions	= 1-3 (2 is optional)
	 Concur. Resolutions	= 1-5, 6&7 optional/unknown
	...
	if ([[bill objectForKey:@"type"] containsObject:@"bill"])
		billType = BillTypeBill;
	else if ([[bill objectForKey:@"type"] containsObject:@"concurrent resolution"])
		billType = BillTypeConcurrentResolution;
	else if ([[bill objectForKey:@"type"] containsObject:@"joint resolution"])
...
- (NSMutableDictionary *)parseStagesForBill:(NSMutableDictionary *)bill {
	...
	[bill setObject:stages forKey:@"stages"];
	return stages;
}	
@end
