...
GeneralTableViewController is the controller class that is used for each of
...
The GeneralTableViewController is responsible for creating and configuring
instances of UITableView when requested. The GeneralTableViewController class
...
As the UITableView delegate an instance of the GeneralTableViewController
...
view controller to push an instance of the DetailTableViewController class
...
The data source classes provide the data for the GeneralTableViewController,
...
DirectoryDataSource, LegislationDataSource,
MapImagesDataSource, and MainMenuDataSource.
...
These classes also adopt the TableDataSource protocol. This protocol is
defined by the application and provides a uniform means for the
GeneralTableViewController to determine the title displayed in the tab bar
...
the table's delegate (GeneralTableViewController) receives a message. Upon
receiving this event the GeneralTableViewController asks its data source
...
DetailTableViewController class onto the navigation stack.

The DetailTableViewController is responsible for displaying the single
...
DetailTableViewController. It displays the atomic name, number, symbol, and
...
Version 1.6
  ...
  - The UITableViewDelegate method tableView: cellForRowAtIndexPath: was
	...
	the GeneralTableViewController class and each of the datasources.
...
Version 1.3
  - Updated with API changes  for third beta release of iPhone
    ...
    - Changed cell creation mechanism in GeneralTableViewController.m
...
Version 1.2
  ...
  - New implementation of the view reflection in the Single Element
    ...
    - See AtomicElementView.m for
      ...
      the reflection image. See DetailTableViewController.m for the
  ...
  - Elements by Name table now displays alphabetical side index
    ...
    - Added new method to the TableDataSource protocol to return if
