...
- (void) setupHeader;
- (CommitteeDetailDataSource *)createOrReturnDataSourceForObject:(SLFCommittee *)obj;
...
- (NSString *)detailObjectID {
    return self.detailObject.committeeID;
}

- (void)setDetailObjectID:(NSString *)newID {  
    SLFCommittee *committee = [SLFCommittee findFirstByAttribute:@"committeeID" withValue:newID];
    CommitteeDetailDataSource *dsource = [self createOrReturnDataSourceForObject:committee];
    dsource.detailObject = committee;
...
- (CommitteeDetailDataSource *)createOrReturnDataSourceForObject:(SLFCommittee *)obj {
    if (!dataSource) {
		dataSource = [[CommitteeDetailDataSource alloc] initWithDetailObject:obj];
