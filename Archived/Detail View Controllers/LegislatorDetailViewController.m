...
- (void) setupHeader;
- (LegislatorDetailDataSource *)createOrReturnDataSourceForObject:(SLFLegislator *)obj;
...
- (void)viewDidLoad {
    ...
    self.tableView.dataSource = [self createOrReturnDataSourceForObject:nil];
...
- (NSString *)detailObjectID {
    return self.detailObject.legID;
}

- (void)setDetailObjectID:(NSString *)newID {  
    SLFLegislator *member = [SLFLegislator findFirstByAttribute:@"legID" withValue:newID];
    LegislatorDetailDataSource *dsource = [self createOrReturnDataSourceForObject:member];
    dsource.detailObject = member;
...
- (LegislatorDetailDataSource *)createOrReturnDataSourceForObject:(SLFLegislator *)member {
    if (!dataSource) {
		dataSource = [[LegislatorDetailDataSource alloc] initWithDetailObject:member];
        [[NSNotificationCenter defaultCenter] addObserver:self 
